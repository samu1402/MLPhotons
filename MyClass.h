...
// Thu Aug  1 14:40:48 2024 by ROOT version 6.30/06
// from TTree Events/Events
// found on file: Haa4e_mass20MeV_ctau010um_MLNanoAODv9_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nboostedTau;
   Float_t         boostedTau_chargedIso[30];   //[nboostedTau]
   Float_t         boostedTau_eta[30];   //[nboostedTau]
   Float_t         boostedTau_leadTkDeltaEta[30];   //[nboostedTau]
   Float_t         boostedTau_leadTkDeltaPhi[30];   //[nboostedTau]
   Float_t         boostedTau_leadTkPtOverTauPt[30];   //[nboostedTau]
   Float_t         boostedTau_mass[30];   //[nboostedTau]
   Float_t         boostedTau_neutralIso[30];   //[nboostedTau]
   Float_t         boostedTau_phi[30];   //[nboostedTau]
   Float_t         boostedTau_photonsOutsideSignalCone[30];   //[nboostedTau]
   Float_t         boostedTau_pt[30];   //[nboostedTau]
   Float_t         boostedTau_puCorr[30];   //[nboostedTau]
   Float_t         boostedTau_rawAntiEle2018[30];   //[nboostedTau]
   Float_t         boostedTau_rawIso[30];   //[nboostedTau]
   Float_t         boostedTau_rawIsodR03[30];   //[nboostedTau]
   Float_t         boostedTau_rawMVAnewDM2017v2[30];   //[nboostedTau]
   Float_t         boostedTau_rawMVAoldDM2017v2[30];   //[nboostedTau]
   Float_t         boostedTau_rawMVAoldDMdR032017v2[30];   //[nboostedTau]
   Int_t           boostedTau_charge[30];   //[nboostedTau]
   Int_t           boostedTau_decayMode[30];   //[nboostedTau]
   Int_t           boostedTau_jetIdx[30];   //[nboostedTau]
   Int_t           boostedTau_rawAntiEleCat2018[30];   //[nboostedTau]
   UChar_t         boostedTau_idAntiEle2018[30];   //[nboostedTau]
   UChar_t         boostedTau_idAntiMu[30];   //[nboostedTau]
   UChar_t         boostedTau_idMVAnewDM2017v2[30];   //[nboostedTau]
   UChar_t         boostedTau_idMVAoldDM2017v2[30];   //[nboostedTau]
   UChar_t         boostedTau_idMVAoldDMdR032017v2[30];   //[nboostedTau]
   ...
   UInt_t          nElectron;
   Float_t         Electron_deltaEtaSC[30];   //[nPhoton]
   Float_t         Electron_dr03EcalRecHitSumEt[30];   //[nPhoton]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[30];   //[nPhoton]
   Float_t         Electron_dr03TkSumPt[30];   //[nPhoton]
   Float_t         Electron_dr03TkSumPtHEEP[30];   //[nPhoton]
   Float_t         Electron_dxy[30];   //[nPhoton]
   Float_t         Electron_dxyErr[30];   //[nPhoton]
   Float_t         Electron_dz[30];   //[nPhoton]
   Float_t         Electron_dzErr[30];   //[nPhoton]
   Float_t         Electron_eInvMinusPInv[30];   //[nPhoton]
   Float_t         Electron_energyErr[30];   //[nPhoton]
   Float_t         Electron_eta[30];   //[nPhoton]
   Float_t         Electron_hoe[30];   //[nPhoton]
   Float_t         Electron_ip3d[30];   //[nPhoton]
   Float_t         Electron_jetPtRelv2[30];   //[nPhoton]
   Float_t         Electron_jetRelIso[30];   //[nPhoton]
   Float_t         Electron_mass[30];   //[nPhoton]
   Float_t         Electron_miniPFRelIso_all[30];   //[nPhoton]
   Float_t         Electron_miniPFRelIso_chg[30];   //[nPhoton]
   Float_t         Electron_mvaFall17V2Iso[30];   //[nPhoton]
   Float_t         Electron_mvaFall17V2noIso[30];   //[nPhoton]
   Float_t         Electron_pfRelIso03_all[30];   //[nPhoton]
   Float_t         Electron_pfRelIso03_chg[30];   //[nPhoton]
   Float_t         Electron_phi[30];   //[nPhoton]
   Float_t         Electron_pt[30];   //[nPhoton]
   Float_t         Electron_r9[30];   //[nPhoton]
   Float_t         Electron_scEtOverPt[30];   //[nPhoton]
   Float_t         Electron_sieie[30];   //[nPhoton]
   Float_t         Electron_sip3d[30];   //[nPhoton]
   Float_t         Electron_mvaTTH[30];   //[nPhoton]
   Int_t           Electron_charge[30];   //[nPhoton]
   Int_t           Electron_cutBased[30];   //[nPhoton]
   Int_t           Electron_jetIdx[30];   //[nPhoton]
   Int_t           Electron_pdgId[30];   //[nPhoton]
   Int_t           Electron_photonIdx[30];   //[nPhoton]
   Int_t           Electron_tightCharge[30];   //[nPhoton]
   Int_t           Electron_vidNestedWPBitmap[30];   //[nPhoton]
   Int_t           Electron_vidNestedWPBitmapHEEP[30];   //[nPhoton]
   Bool_t          Electron_convVeto[30];   //[nPhoton]
   Bool_t          Electron_cutBased_HEEP[30];   //[nPhoton]
   Bool_t          Electron_isPFcand[30];   //[nPhoton]
   UChar_t         Electron_jetNDauCharged[30];   //[nPhoton]
   UChar_t         Electron_lostHits[30];   //[nPhoton]
   Bool_t          Electron_mvaFall17V2Iso_WP80[30];   //[nPhoton]
   Bool_t          Electron_mvaFall17V2Iso_WP90[30];   //[nPhoton]
   Bool_t          Electron_mvaFall17V2Iso_WPL[30];   //[nPhoton]
   Bool_t          Electron_mvaFall17V2noIso_WP80[30];   //[nPhoton]
   Bool_t          Electron_mvaFall17V2noIso_WP90[30];   //[nPhoton]
   Bool_t          Electron_mvaFall17V2noIso_WPL[30];   //[nPhoton]
   UChar_t         Electron_seedGain[30];   //[nPhoton]
   UInt_t          nFatJet;
   ...
   Float_t         LHEReweightingWeight[4];   //[nLHEReweightingWeight]
   ...
   UInt_t          nMLPhoton;
   Float_t         MLPhoton_diphotonScore[30];   //[nMLPhoton]
   Float_t         MLPhoton_eta[30];   //[nMLPhoton]
   Float_t         MLPhoton_hadronScore[30];   //[nMLPhoton]
   Float_t         MLPhoton_mass[30];   //[nMLPhoton]
   Float_t         MLPhoton_massEnergyRatio[30];   //[nMLPhoton]
   Float_t         MLPhoton_monophotonScore[30];   //[nMLPhoton]
   Float_t         MLPhoton_pfIsolation[30];   //[nMLPhoton]
   Float_t         MLPhoton_phi[30];   //[nMLPhoton]
   Float_t         MLPhoton_pt[30];   //[nMLPhoton]
   Float_t         MLPhoton_r1[30];   //[nMLPhoton]
   Float_t         MLPhoton_r2[30];   //[nMLPhoton]
   Float_t         MLPhoton_r3[30];   //[nMLPhoton]
   UInt_t          nMuon;
   ...
   UInt_t          nPhoton;
   Float_t         Photon_dEscaleDown[30];   //[nPhoton]
   Float_t         Photon_dEscaleUp[30];   //[nPhoton]
   Float_t         Photon_dEsigmaDown[30];   //[nPhoton]
   Float_t         Photon_dEsigmaUp[30];   //[nPhoton]
   Float_t         Photon_eCorr[30];   //[nPhoton]
   Float_t         Photon_energyErr[30];   //[nPhoton]
   Float_t         Photon_eta[30];   //[nPhoton]
   Float_t         Photon_hoe[30];   //[nPhoton]
   Float_t         Photon_mass[30];   //[nPhoton]
   Float_t         Photon_mvaID[30];   //[nPhoton]
   Float_t         Photon_mvaID_Fall17V1p1[30];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all[30];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg[30];   //[nPhoton]
   Float_t         Photon_phi[30];   //[nPhoton]
   Float_t         Photon_pt[30];   //[nPhoton]
   Float_t         Photon_r9[30];   //[nPhoton]
   Float_t         Photon_sieie[30];   //[nPhoton]
   Int_t           Photon_charge[30];   //[nPhoton]
   Int_t           Photon_cutBased[30];   //[nPhoton]
   Int_t           Photon_cutBased_Fall17V1Bitmap[30];   //[nPhoton]
   Int_t           Photon_electronIdx[30];   //[nPhoton]
   Int_t           Photon_jetIdx[30];   //[nPhoton]
   Int_t           Photon_pdgId[30];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[30];   //[nPhoton]
   Bool_t          Photon_electronVeto[30];   //[nPhoton]
   Bool_t          Photon_isScEtaEB[30];   //[nPhoton]
   Bool_t          Photon_isScEtaEE[30];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[30];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[30];   //[nPhoton]
   Bool_t          Photon_pixelSeed[30];   //[nPhoton]
   UChar_t         Photon_seedGain[30];   //[nPhoton]
   ...
   Int_t           boostedTau_genPartIdx[30];   //[nboostedTau]
   UChar_t         boostedTau_genPartFlav[30];   //[nboostedTau]
   Int_t           Electron_genPartIdx[30];   //[nPhoton]
   UChar_t         Electron_genPartFlav[30];   //[nPhoton]
   ...
   Int_t           Photon_genPartIdx[30];   //[nPhoton]
   UChar_t         Photon_genPartFlav[30];   //[nPhoton]
   Float_t         MET_fiducialGenPhi;
   Float_t         MET_fiducialGenPt;
   UChar_t         Electron_cleanmask[30];   //[nPhoton]
   UChar_t         Jet_cleanmask[16];   //[nJet]
   UChar_t         Muon_cleanmask[6];   //[nMuon]
   UChar_t         Photon_cleanmask[30];   //[nPhoton]
   ...
   TBranch        *b_nMLPhoton;   //!
   TBranch        *b_MLPhoton_diphotonScore;   //!
   TBranch        *b_MLPhoton_eta;   //!
   TBranch        *b_MLPhoton_hadronScore;   //!
   TBranch        *b_MLPhoton_mass;   //!
   TBranch        *b_MLPhoton_massEnergyRatio;   //!
   TBranch        *b_MLPhoton_monophotonScore;   //!
   TBranch        *b_MLPhoton_pfIsolation;   //!
   TBranch        *b_MLPhoton_phi;   //!
   TBranch        *b_MLPhoton_pt;   //!
   TBranch        *b_MLPhoton_r1;   //!
   TBranch        *b_MLPhoton_r2;   //!
   TBranch        *b_MLPhoton_r3;   //!
   TBranch        *b_nMuon;   //!
   TBranch        *b_Muon_dxy;   //!
...
#ifdef MyClass_cxx
MyClass::MyClass(TChain *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Haa4e_mass20MeV_ctau010um_MLNanoAODv9_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Haa4e_mass20MeV_ctau010um_MLNanoAODv9_0.root");
      }
...
void MyClass::Init(TChain *tree)
{
   ...
   fChain->SetBranchAddress("nMLPhoton", &nMLPhoton, &b_nMLPhoton);
   fChain->SetBranchAddress("MLPhoton_diphotonScore", MLPhoton_diphotonScore, &b_MLPhoton_diphotonScore);
   fChain->SetBranchAddress("MLPhoton_eta", MLPhoton_eta, &b_MLPhoton_eta);
   fChain->SetBranchAddress("MLPhoton_hadronScore", MLPhoton_hadronScore, &b_MLPhoton_hadronScore);
   fChain->SetBranchAddress("MLPhoton_mass", MLPhoton_mass, &b_MLPhoton_mass);
   fChain->SetBranchAddress("MLPhoton_massEnergyRatio", MLPhoton_massEnergyRatio, &b_MLPhoton_massEnergyRatio);
   fChain->SetBranchAddress("MLPhoton_monophotonScore", MLPhoton_monophotonScore, &b_MLPhoton_monophotonScore);
   fChain->SetBranchAddress("MLPhoton_pfIsolation", MLPhoton_pfIsolation, &b_MLPhoton_pfIsolation);
   fChain->SetBranchAddress("MLPhoton_phi", MLPhoton_phi, &b_MLPhoton_phi);
   fChain->SetBranchAddress("MLPhoton_pt", MLPhoton_pt, &b_MLPhoton_pt);
   fChain->SetBranchAddress("MLPhoton_r1", MLPhoton_r1, &b_MLPhoton_r1);
   fChain->SetBranchAddress("MLPhoton_r2", MLPhoton_r2, &b_MLPhoton_r2);
   fChain->SetBranchAddress("MLPhoton_r3", MLPhoton_r3, &b_MLPhoton_r3);
